...
class ModelPrinter(models.Model):
    ...
    cartridge=models.ManyToManyField(ModelCartridge)#,related_name="modelprinter_have_modelcartridge",on_delete=models.CASCADE,null=True
    def __str__(self):
        return self.name
class WorkUnit(models.Model):
    ...
    status_cartridge=models.BooleanField(default=True)
...
class ActCartridge(models.Model):
    date=models.DateField(default=datetime.date.today)
    status=models.IntegerField(default=0)
    cartridge=models.ForeignKey(ModelCartridge,related_name="actcartridge_have_modelcartridge",on_delete=models.CASCADE)
    printer=models.ForeignKey(WorkUnit,related_name="actcartridge_have_workunit",on_delete=models.CASCADE)
